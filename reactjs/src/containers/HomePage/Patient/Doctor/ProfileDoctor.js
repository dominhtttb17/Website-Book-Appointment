  ...
  render() {
    ...
    return (
     ...
     <div className="intro-doctor-grid">
       ...
       {isShowLinkDetail === true && <div onClick={()=>this.handleOnClickDetailDoctor(doctorId)} className="detailSpecialty-profile">Xem them</div>}
     
       <div className="price">

       <FormattedMessage id="patient.patient-doctor.title-price"/>
                {dataProfile&& dataProfile.Doctor_Info&& dataProfile.Doctor_Info.priceTypeData && language===LANGUAGES.VI&& (
                      <NumberFormat
                  ...
                  {dataProfile&& dataProfile.Doctor_Info&& dataProfile.Doctor_Info.priceTypeData && language===LANGUAGES.EN && (
                      <NumberFormat
